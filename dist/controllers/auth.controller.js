...
exports.logoutController = exports.loginFunction = exports.loginController = void 0;
...
var loginFunction = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, existingUser, matchedPassword, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, email = _a.email, password = _a.password;
            ...
            case 4:
                error_2 = _b.sent();
                console.log(error_2);
                res.render("pages/login", { layout: false, error: error_2.message });
                return [3 /*break*/, 5];
            case 5: return [2 /*return*/];
        }
    });
